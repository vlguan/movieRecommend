// movieQuery.js (your implementation)
// import { movieQuery } from './tmdb';
...
describe('movieQuery', () => {
  it('fetches successfully data from an API', async () => {
    const mockResponse = { data: { "page": 1,
    "results": [
      {
        "adult": false,
    ...
    // You can also mock process.env.API_KEY and process.env.BASEURL if needed
    ...
    // Assert that the function prints the correct response
  ...
  it('handles errors gracefully', async () => {
    ...
    // Invoke the function and await the result
    await movieQuery(query);

    // Assert that the function prints the correct error message
